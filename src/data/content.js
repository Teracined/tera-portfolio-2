...
export const projects = [
  ...
  },
  {
    ...
    title: '《刻刀》',
    role: '导演 · 后期剪辑',
    period: '第 14 届 NCDA · 2026.08 获奖',
    metric: 'NCDA 广东省赛区 二等奖',
    desc: '紧扣"科技赋能匠心，爱使传承不息"主题，主导完成该短片的剧本构思、画面生成与后期制作。深入应用 AI 视频生成技术，突破传统实拍限制，将传统木雕工艺场景与未来机甲元素进行电影级的高质感视觉融合；利用非线性编辑软件进行精细化剪辑与沉浸式音效设计，通过细腻的镜头语言与节奏把控，精准刻画父子情感羁绊与技艺传承。作品获第 14 届未来设计师·全国高校数字艺术设计大赛（NCDA）广东省赛区二等奖，全面展现了前沿 AI 工具在影视工业流中的实战转化能力。',
    tags: ['AIGC', 'AI 视频生成', '微电影', 'NCDA 二等奖'],
    accent: 'linear-gradient(135deg,#f59e0b,#ef4444)',
    cover: '/work-carve.jpg',
    certificate: '/ncda-cert.jpg',
    certificateLabel: '证书查看',
